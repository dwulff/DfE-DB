...
option_ev = dict(A=65, B=55)  # , C=1300, D=1225, E=1300, F=1225
sqrOption = [10, 10]
optionA = np.random.normal(loc=option_ev['A'], scale=sqrOption[0], size=1000)
optionB = np.random.normal(loc=option_ev['B'], scale=sqrOption[1], size=1000)
option_inf = dict(A=optionA, B=optionB)
option_range = dict(A=[option_ev['A']-3*sqrOption[0], option_ev['A']+3*sqrOption[0]], B=[option_ev['B']-3*sqrOption[1], option_ev['B']+3*sqrOption[1]])
