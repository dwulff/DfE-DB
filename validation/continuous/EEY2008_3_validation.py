...
option_ev = dict(A=0.5, B=1, C=3.5, D=4, E=0.25, F=1, G=12.25, H=13, I=100.5, J=101, K=103.5, L=104, M=100.25, N=101, O=112.25, P=113)
sqrOption = dict(E=0.177, F=3.54, G=0.177, H=3.54, M=0.177, N=3.54, O=0.177, P=3.54)
optionA = np.random.uniform(low=0, high=1, size=1000)
optionB0 = np.random.uniform(low=-1, high=0, size=500)
optionB1 = np.random.uniform(low=2, high=3, size=500)
optionB = np.concatenate((optionB0, optionB1), axis=0)
optionC = np.random.uniform(low=3, high=4, size=1000)
optionD0 = np.random.uniform(low=2, high=3, size=500)
optionD1 = np.random.uniform(low=5, high=6, size=500)
optionD = np.concatenate((optionD0, optionD1), axis=0)
optionE0 = np.random.normal(loc=option_ev['E'], scale=sqrOption['E'], size=5000)
optionE0 = optionE0[optionE0 > 0]
if len(optionE0) > 1000:
    optionE = np.random.choice(optionE0, size=1000, replace=False)
optionF = np.random.normal(loc=option_ev['F'], scale=sqrOption['F'], size=1000)
optionG = optionE + 12
optionH = optionF + 12
optionI = 100 * optionA
optionJ = 100 * optionB
...
optionO = 100 * optionG
optionP = 100 * optionH
option_inf = dict(A=optionA, B=optionB, C=optionC, D=optionD, E=optionE, F=optionF, G=optionG, H=optionH, I=optionI, J=optionJ, K=optionK, L=optionL, M=optionM, N=optionN, O=optionO, P=optionP)
option_range = dict(A=[0, 1], B=[-1, 3], C=[3, 4], D=[2, 6], E=[0, option_ev['E']+3*sqrOption['E']], F=[option_ev['F']-3*sqrOption['F'], option_ev['F']+3*sqrOption['F']],
                    G=[12, option_ev['G']+3*sqrOption['G']], H=[option_ev['H']-3*sqrOption['H'], option_ev['H']+3*sqrOption['H']],
                    I=[0, 100], J=[-100, 300], K=[300, 400], L=[200, 600], M=[0, 100*(option_ev['E'] + 3 * sqrOption['E'])],
                    N=[x*100 for x in [option_ev['F'] - 3 * sqrOption['F'], option_ev['F'] + 3 * sqrOption['F']]],
                    O=[1200, 100*(option_ev['G'] + 3 * sqrOption['G'])],
                    P=[x*100 for x in [option_ev['H'] - 3 * sqrOption['H'], option_ev['H'] + 3 * sqrOption['H']]])
option_ev = dict(A=0.5, B=1, C=3.5, D=4, E=0.256, F=1, G=12.256, H=13, I=100.5, J=101, K=103.5, L=104, M=100.256, N=101, O=112.256, P=113)
